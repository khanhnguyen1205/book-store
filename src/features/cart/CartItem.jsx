    ...
    return (
        <div className="cart-item">
            <div className="cart-item-cover">
                {item.image ? <img src={item.image} alt={item.title} /> : <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--paper-mute)', fontSize: 10 }}>No Cover</div>}
            </div>
