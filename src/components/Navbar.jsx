  ...
  return (
    <nav className="lg-nav">
      ...
      <div className="lg-nav-right">
        ...
        <Link to="/cart" className="lg-cart-link" title="Cart" aria-label={`Cart, ${cartItemCount} items`}>
          <span className="lg-cart">
            ...
            {cartItemCount > 0 && <span className="lg-cart-badge">{cartItemCount}</span>}
          </span>
